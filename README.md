...
1. скачайте и распакуйте архив **GNU-Linux.tar.gz** со [страницы с релизами](https://github.com/Henry-Tsukino/wbg-albiondata-client/releases)
  ...
  4. при наличии проблем попробовать повторить шаги с второго по третий, и\или выполнить инструкции которые вам возможно укажет установщик.
     - Если же установщик крашится или не выводит конкретных проблем и путей решения перейдите на [шаг 7.](https://github.com/Henry-Tsukino/wbg-albiondata-client?tab=readme-ov-file#7.-выход-из-безвыходных-ситуаций)
     - при повторном их возникновении в процессе установки и\или выполнения программы перейдите на [шаг 7.](https://github.com/Henry-Tsukino/wbg-albiondata-client?tab=readme-ov-file#7.-выход-из-безвыходных-ситуаций)
  5. если же у вас всё отлично установилось, но приложение не отображается на рабочем столе, то запустите через поиск приложения в вашей системе, например в PlasmaKde это отрывается нажатием кнопки Meta(Super).
     - Или если же программа после запуска крашится и/или не выводит конкретных проблем и путей решения, перейдите на [шаг 7.](https://github.com/Henry-Tsukino/wbg-albiondata-client?tab=readme-ov-file#7.-выход-из-безвыходных-ситуаций)
