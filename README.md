...
1. скачайте и распакуйте архив **GNU-Linux.tar.gz** со [страницы с релизами](https://github.com/Henry-Tsukino/wbg-albiondata-client/releases)
  ...
  3. вас попросят `sudo пароль`, не пугайтесь, это нужно для просмотра сетевых пакетов, это основной принцип работы сея программы.
  4. при наличии проблем попробовать повторить шаги с второго по третий, и\или выполнить инструкции которые вам возможно укажет установщик.
     - Если же установщик крашится или не выводит конкретных проблем и путей решения перейдите на [шаг 7.](https://github.com/Henry-Tsukino/wbg-albiondata-client?tab=readme-ov-file#6.-выход-из-безвыходных-ситуаций)[^1]
     - при повторном их возникновении в процессе установки и\или выполнения программы перейдите на [шаг 7.](https://github.com/Henry-Tsukino/wbg-albiondata-client?tab=readme-ov-file#6.-выход-из-безвыходных-ситуаций)[^1]
  5. если же у вас всё отлично установилось, но приложение не отображается на рабочем столе, то запустите через поиск приложения в вашей системе, например в PlasmaKde это отрывается нажатием кнопки Meta(Super).
     - Или если же программа после запуска крашится и/или не выводит конкретных проблем и путей решения, перейдите на [шаг 7.](https://github.com/Henry-Tsukino/wbg-albiondata-client?tab=readme-ov-file#6.-выход-из-безвыходных-ситуаций)[^1]
   6. пользоваться с гордостью, так как вы делаете доброе дело.
> [!TIP]   
> если хотите, поставьте на автозапуск так как программа потребляет всего `~20мб ОЗУ`.

> [!WARNING]
> [^1]##### 7. выход из безвыходных ситуаций
> - Напишите мне в личные сообщения в DISCORD (pinok.tsukino).
> - или постарайтесь связаться со мной там, где вы нашли этот установщик.
> - также конечно можно и просто задавать впоросы.
